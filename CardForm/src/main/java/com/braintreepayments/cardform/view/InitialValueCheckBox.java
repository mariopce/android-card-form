...
public class InitialValueCheckBox extends AppCompatCheckBox {
    private static final String EXTRA_SUPER_STATE = "com.braintreepayments.cardform.view.DefaultValueCheckBox.EXTRA_SUPER_STATE";
    private static final String EXTRA_CHECKED_VALUE = "com.braintreepayments.cardform.view.DefaultValueCheckBox.EXTRA_CHECKED_VALUE";
